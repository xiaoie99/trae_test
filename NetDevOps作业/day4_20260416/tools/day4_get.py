...
if __name__ == "__main__":
    ...
    # cpmCPUMemoryUsed
    print(asyncio.run(snmpv2_get(ip_address, community, "1.3.6.1.4.1.9.9.48.1.1.1.5.1", port=161)))
    # cpmCPUMemoryFree
    print(asyncio.run(snmpv2_get(ip_address, community, "1.3.6.1.4.1.9.9.48.1.1.1.6.1", port=161)))